...
# separate object yet.)
MODULES = src/rng.cpp src/physics.cpp src/assets.cpp src/zxvga.cpp src/bricks.cpp src/sound.cpp src/hud.cpp src/objects.cpp src/weapons.cpp src/enemies.cpp src/bonus_codes.cpp
...
test-fast: test-video test-rng test-physics test-assets test-bricks \
           ...
           test-bonus-codes test-source-gates
