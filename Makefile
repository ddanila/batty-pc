...
# separate object yet.)
MODULES = src/rng.cpp src/physics.cpp src/assets.cpp src/zxvga.cpp src/bricks.cpp src/sound.cpp src/hud.cpp src/objects.cpp src/weapons.cpp
