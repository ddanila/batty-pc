...
**The code.** `main.cpp`: 7,747 → 8,233 lines (net -1) across 15
...
**The tests.** 100 gates, indexed in `notes/testing.md` and kept complete
by `test-gate-index`. They fall in three groups:

  - 72 QEMU gates — **`python3 scripts/run_gates_parallel.py --full`**,
