...
**The code.** `main.cpp`: 7,747 → 7,944 lines (net -1) across 15
...
**The tests.** 96 gates, indexed in `notes/testing.md` and kept complete
by `test-gate-index`. They fall in three groups:

  - 68 QEMU gates — **`python3 scripts/run_gates_parallel.py --full`**,
