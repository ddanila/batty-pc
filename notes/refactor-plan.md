...
**The code.** `main.cpp`: 7,747 → 7,113 lines (-8.2%) across 15
...
**The tests.** 81 gates, indexed in `notes/testing.md` and kept complete
...
`main.cpp`: 7,747 → 7,113 (`wc -l`; see the status block on why this is not Watcom's count).
