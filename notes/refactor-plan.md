...
**The code.** `main.cpp`: 7,747 → 7,758 lines (--0.1%) across 15
...
**The tests.** 91 gates, indexed in `notes/testing.md` and kept complete
...
`main.cpp`: 7,747 → 7,758 (`wc -l`; see the status block on why this is not Watcom's count).
