...
**The code.** `main.cpp`: 7,747 → 6,918 lines (-10.7%) across 15
...
**The tests.** 77 gates, indexed in `notes/testing.md` and kept complete
...
`main.cpp`: 7,747 → 6,918 (`wc -l`; see the status block on why this is not Watcom's count).
