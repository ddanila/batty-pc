...
**The code.** `main.cpp`: 7,747 → 7,507 lines (-3.1%) across 15
...
**The tests.** 84 gates, indexed in `notes/testing.md` and kept complete
...
`main.cpp`: 7,747 → 7,507 (`wc -l`; see the status block on why this is not Watcom's count).
