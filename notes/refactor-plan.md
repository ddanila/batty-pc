...
**The code.** `main.cpp`: 7,747 → 8,299 lines (net -1) across 15
...
**The tests.** 101 gates, indexed in `notes/testing.md` and kept complete
by `test-gate-index`. They fall in three groups:

  - 73 QEMU gates — **`python3 scripts/run_gates_parallel.py --full`**,
