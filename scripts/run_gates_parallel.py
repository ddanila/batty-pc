...
FULL_EXTRA_GATES = [
    ...
    "test-game-over",
    "test-game-over-visual", "test-name-entry-visual", "test-life-loss", "test-life-respawn", "test-respawn-redraw", "test-level-advance", "test-stuck-ball-offset", "test-invariant-owners",
