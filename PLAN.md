...
| 3 | Core gameplay byte-exact where an oracle exists (ball, bat, collision, RNG, enemy, bonuses, scoring) | **Done** — regression-locked by 109 gates |
...
2. **MAGNET catch for secondary balls:** catching the unified
   ...
   **Structural half done 2026-08-09.** The three fields are `[3]`,
